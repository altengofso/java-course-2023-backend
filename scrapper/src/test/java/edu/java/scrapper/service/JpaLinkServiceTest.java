...
public class JpaLinkServiceTest extends IntegrationEnvironment {
    ...
    void addLinkTest() {
        ...
        LinkDto linkDto = jpaLinkRepository.findByUrl(new URI(URL)).orElseThrow();
        SubscriptionDto subscriptionDto =
            jpaSubscriptionRepository.getReferenceById(new SubscriptionId(expected.id(), CHAT_ID));
    ...
    void deleteLinkTest() {
        ...
        assertThat(jpaLinkRepository.findByUrl(new URI(URL))).isNotPresent();
    }
